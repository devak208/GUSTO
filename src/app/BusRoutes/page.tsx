...
export default function BusRoutes() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden bg-white dark:bg-black dark:bg-grid-white/[0.2] bg-grid-black/[0.2]">
      <StarsBackground className="z-0 opacity-60" />
      <ShootingStars className="z-0 fixed inset-0" />
      <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
        <div className="w-full h-full bg-gradient-to-b from-transparent via-white/50 to-transparent dark:via-black/50" />
      </div>
            ...
            {filteredRoutes.length > 0 ? (
              filteredRoutes.map((route, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="bg-white/90 dark:bg-gray-900/90 rounded-xl shadow-lg border border-gray-200 dark:border-gray-800 overflow-hidden backdrop-blur-sm hover:shadow-xl transition-all duration-300">
                    <div className="p-6">
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-12">
                <div className="bg-white/90 dark:bg-gray-900/90 rounded-xl p-8 backdrop-blur-sm">
